...
[Github](https://github.com/ppthqnhqp/build-ml-pipeline-for-short-term-rental-prices)
...
```
git clone https://github.com/ppthqnhqp/build-ml-pipeline-for-short-term-rental-prices.git
```
